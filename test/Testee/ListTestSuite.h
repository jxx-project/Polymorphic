	...
	ListTestSuite(const std::string& listType)
		: TestSuite(
		  ...
		  [] {
			  ...
			  TestCase::assert(
			  std::is_same<typename ListType<T, Allocator>::iterator, decltype(result)>::value, "type");
		  ...
		  [] {
			  ...
			  TestCase::assert(
			  std::is_same<typename ListType<T, Allocator>::size_type, decltype(result)>::value, "type");
		  ...
		  [] {
			  ...
			  TestCase::assert(
			  std::is_same<typename ListType<T, Allocator>::reference, decltype(result)>::value, "type");
			  TestCase::assert(result == T(), "result");
		  }),
...
const typename ListTestSuite<ListType, T, Allocator>::InitializerListType
ListTestSuite<ListType, T, Allocator>::INITIALIZER_LIST = {T()};
